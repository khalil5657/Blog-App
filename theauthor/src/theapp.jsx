      ...
      <Router>
        <div>
          <nav>
            ...
            <button onClick={()=>logOut()} className={styles.logout}>Log out</button><br />
            <Link to="/createPost" className={styles.createPost}>Create a Post</Link></>:
            <Link to="/login" className={styles.logout}>Log In?</Link>
            }
